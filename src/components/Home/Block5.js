...
const Block5 = () => {
  return (
    <Container>
      ...
      <Text>
        L’arche de Noé enseigne l’arabe suivant la méthode des livres de la
        Madrassah de Cheikh Ayoub Leseur.
      </Text>
      <Text>
        Les supports utilisés sont les manuels de la Madrassah. Une de nos
        principales activités est l’enseignement de la langue arabe. Nous
        portons une attention particulière à cet héritage culturel et religieux
        car il est le vecteur d’une religion ainsi que de toute une civilisation
      ...
      <Button to='/formation'>Les formations de langue Arabe</Button>
    </Container>
  )
}
