...
const Block5Bis = () => {
  return (
    <Container>
      ...
      >
        <LeftBlockTitle>L’Apprentissage de la <br />
          <span style={{ color: '#04b8d7' }}>
            langue Arabe
          </span>
        </LeftBlockTitle>
      ...
      <RightBlock
        ...
        data-aos-duration='2000'
      >
        <RightBlockTitle>Ce que me permet l’apprentissage de la langue Arabe</RightBlockTitle>
        <IconsContainer>
          <IconBox>
            <Icon>
              <img style={{ width: '3.8em', height: '4.8em' }} src={quranIcon} alt='' />
            </Icon>
          ...
          <IconBox>
            ...
            <IconText>Communiquer avec des <br /> millions de personnes</IconText>
          </IconBox>
          ...
          <IconBox>
            ...
            <IconText>Un tremplin vers <br /> l’étude de la science <br /> religieuse.
            </IconText>
          </IconBox>
          ...
          <IconBox>
            ...
            <IconText>Enseigner aux <br /> membres de ma <br /> communauté</IconText>
          </IconBox>
        </IconsContainer>
      </RightBlock>
    </Container>
